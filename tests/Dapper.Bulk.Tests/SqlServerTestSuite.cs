...
{
    private static readonly string ConnectionString = "Server=localhost;Database=DapperBulkTest;TrustServerCertificate=True;Trusted_Connection=True;MultipleActiveResultSets=true;";
